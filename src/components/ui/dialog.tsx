  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "gap-4 rounded-xl border border-border bg-popover p-6 text-popover-foreground shadow-2xl",
        "data-[state=open]:animate-in data-[state=closed]:animate-out",
        "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
    ...
    >
      ...
      <DialogPrimitive.Close
        className={cn(
          "absolute right-3 top-3 grid size-8 place-items-center rounded-md text-muted-foreground",
